<div class="header">
   <div class="header-left">
      <a href="/" class="logo">
         <img src="/backend-files/img/logo.png" width="35" height="35" alt=""> <span>Logo</span>
      </a>
   </div>
...
<!--               <h5>--><?php //= Yii::$app->user->identity->firstname . " " . Yii::$app->user->identity->lastname ?><!-- </h5>-->
<!--               <span>--><?php //= Yii::$app->user->identity->getRoleName() ?><!--</span>-->
            </div>
            <span class="user-img">
