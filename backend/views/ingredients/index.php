...
/** @var common\models\search\IngredientsSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Masalliqlar';
...
<div class="ingredients-index">
    ...
    <p>
        <?= Html::a('Yangi masalliq yaratish', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
...
//                            'id',
                            ...
                            [
                                'attribute' => 'status',
                                'value' => function ($data) {
                                    if ($data->status == Ingredients::STATUS_ACTIVE) {
                                ...
                                'format' => 'raw',
                                'filter' => [Ingredients::STATUS_ACTIVE => 'Faol',Ingredients::STATUS_INACTIVE => 'Faol emas']
                            ],
                            [
